...
void ADCConfiguration(void)
{
	...
	/*
	 * TODO: If you change Memory addresses, please make appropriate changes in interruptFlagMask(Middle one).
	 * I recommend you go to to ADC12_B_clearInterrupt function definition.
	 */

	//Enable memory buffer 2 interrupt
	ADC12_B_enableInterrupt( ADC12_B_BASE, ADCIE, 0, 0 );
	/*
	 * TODO: If you change Memory addresses, please make appropriate changes in interruptFlagMask
	 * I recommend you read to to ADC12_B_enableInterrupt function definition.
	 */
}
...
void ADC12_ISR(void)
{
    ...
    case 36:								// Vector 36:  ADC12BMEM12
    	/*
    	 * TODO: If you change Memory addresses(In mainApp.h), please make appropriate changes in interruptFlagMask(Middle one).
    	 * I recommend you go to to ADC12_B_clearInterrupt function definition.
    	 */
    	ADC12_B_clearInterrupt(ADC12_B_BASE, 0, ADCIFG);
